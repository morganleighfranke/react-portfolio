...
function ProjectCard(props) {
  const projectData = [
    {
      ...
      image: "https://firebasestorage.googleapis.com/v0/b/portfolio-916a8.appspot.com/o/PWA.png?alt=media&token=ddd53921-8ad3-4bca-aee2-7b30fa7091bc",
    ...
    },
    {
      ...
      description: "This was a group project where we integrated NPS and Open Weather API's to be able to search for a state and get a list of all National Parks in that state. When you click on a park, you get specific information about that park so you can plan your trip. You also will get that parks five day weather forecast to the specific latitude and longitude coordinates.",
      image: "",
  ...
  {
    title: "Coding Quiz",
    description: "This was a homework assignment where I created a coding quiz application that features a timer, mutiple choice questions, and saving high scores. ",
    image: "https://firebasestorage.googleapis.com/v0/b/portfolio-916a8.appspot.com/o/Codequiz.png?alt=media&token=fa2fa3d2-4389-4954-ac9f-1a32edb2eb0f",
    githublink: "https://github.com/morganleighfranke/Code_Quiz",
    deployedlink: "https://morganleighfranke.github.io/Code_Quiz/",
},
{
  title: "Workday Scheduler",
  description: "This was a homework assignment that I created to tell the current date and time, add your schedule. The responsive application tells you the current time in red, the past time in gray, and future time in green. It saves your schedule to local storage so you can return to your saved items.",
  image: "https://firebasestorage.googleapis.com/v0/b/portfolio-916a8.appspot.com/o/Workday.png?alt=media&token=906017ab-78aa-4490-ae64-9763208de96c",
